...
class AppLocalizationsKo extends AppLocalizations {
  ...
  @override
  String get updateNewVersionAvailable => '새로운 버전의 NasBeat𒆜가 출시되었습니다!';
  ...
  @override
  String get aboutTipQuote => 'NasBeat가 마음에 드시나요? 소중한 후원이 더 멋진 발전을 만듭니다. 𒆜';
  ...
  String updateAvailableBody(String ver, String build) {
    return '새로운 버전의 NasBeat𒆜가 출시되었습니다!\n\n버전: $ver+$build';
  }
